/*
	24.03.26 TIME 20:49-21:02
		TODAY 소감문
        테이블만 엄청 만들다가 다 지우니까 기분이 굉장히 묘한 것 같다.
        처음에는 왜 이렇게 나를 힘들게 하게 테이블을 많이 만들라고 했을까라는
        생각만 있었는데 각 테이블 들의 컬럼명을 보면 겹치는 게 많다.
        그 말은 즉 관계형 데이터 베이스의 시작을 보여주고 싶은 것 아닌가라는 생각이 든다.
*/
/*    
